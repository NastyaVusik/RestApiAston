package com.example.restapiaston;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class RestApiAstonApplication {

	public static void main(String[] args) {
		SpringApplication.run(RestApiAstonApplication.class, args);
	}
...
//
//		В результате выполненных операций вы должны получить итоговый код, сконкатенировав все его части. Количество символов в коде = 18. В итоге это будет пароль к архиву
//
//
//
//		Необходимые данные:
